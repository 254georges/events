...
if(!empty($_POST["fullname"])) {
  ...
  if($query -> rowCount() > 0)
  {
    ...
    { 
        ...
        $sql="INSERT INTO  tbladmin(Staffid,usertype,UserName,FirstName,LastName,Email,MobileNumber,Password) VALUES(:staffid,:dignity,:fname,:firstname,:lastname,:email,:mobile,:password)";
        $query = $dbh->prepare($sql);
